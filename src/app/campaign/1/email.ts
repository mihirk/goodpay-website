const bccEmails = [
    ...
    "ukcompliance@wellsfargo.com",
    "complaints@barclays.com",
    "wandim.execcomplaints@barclays.com",
    "complaints@monzo.com",
    "complaints@wise.com",
    "customerrelations@virginmoney.com",
    "daniel.pipes@sc.com",
    "niranjan.patel@zenith-bank.co.uk",
